  ...
  return (
    <div className="min-h-screen bg-[#0b0b0c] text-white flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        <button
          onClick={() => reset()}
          className="w-full py-4 bg-white text-black font-black rounded-2xl active:scale-95 transition-transform"
        >
          Try Again
        </button>
        <Link
          href="/vehicles"
          className="w-full py-4 bg-white/5 border border-white/10 text-white font-bold rounded-2xl active:scale-95 transition-transform"
        >
          Back to Vehicles
        </Link>
      </div>
